var creditcard_loan_Module_Factory = function () {
  var creditcard_loan = {
    name: 'creditcard_loan',
    ...
    typeInfos: [{
        ...
        localName: 'CREDITCARDBASEAPPLICANT.FINANCIALINFO.PREVIOUSEMPLOYMENT',
        typeName: null,
        ...
        localName: 'CREDITCARDLOAN',
        typeName: 'CREDITCARD_LOAN',
        baseTypeInfo: '.APP',
        propertyInfos: [{
            name: 'applicants',
            required: true,
            elementName: 'APPLICANTS',
            typeInfo: '.CREDITCARDLOAN.APPLICANTS'
          }, {
            name: 'loaninfo',
            required: true,
            elementName: 'LOAN_INFO',
            typeInfo: '.CREDITCARDLOAN.LOANINFO'
          }, {
            ...
            required: true,
            elementName: 'FUNDING',
            typeInfo: '.CREDITCARDLOAN.FUNDING'
          }, {
            name: 'comments',
            required: true,
            elementName: 'COMMENTS',
            typeInfo: '.CREDITCARDLOAN.COMMENTS'
          }, {
            ...
            collection: true,
            elementName: 'SYSTEM',
            typeInfo: '.CREDITCARDSYSTEM'
          }, {
            name: 'integrationdatalist',
            elementName: 'INTEGRATION_DATA_LIST',
            typeInfo: '.CREDITCARDLOAN.INTEGRATIONDATALIST'
          }, {
        ...
        localName: 'CREDITCARDLOANINFO',
        typeName: 'CREDITCARD_LOAN_INFO',
        baseTypeInfo: '.BASELOANINFO',
        propertyInfos: [{
            name: 'cardholders',
            elementName: 'CARD_HOLDERS',
            typeInfo: '.CREDITCARDLOANINFO.CARDHOLDERS'
          }, {
            ...
            typeInfo: 'Decimal',
            attributeName: {
              localPart: 'requested_credit_limit'
            },
            type: 'attribute'
          }, {
            name: 'requestedCardName',
            attributeName: {
              localPart: 'requested_card_name'
            },
            type: 'attribute'
          }, {
            ...
            name: 'currentCardRate',
            typeInfo: 'Decimal',
            attributeName: {
              localPart: 'current_card_rate'
            },
            type: 'attribute'
          }, {
            name: 'currentCardMargin',
            typeInfo: 'Decimal',
            attributeName: {
              localPart: 'current_card_margin'
            },
            type: 'attribute'
          }]
      }, {
        ...
        localName: 'CREDITCARDLOANINFO.CARDHOLDERS.CARDHOLDER',
        typeName: null,
        propertyInfos: [{
            name: 'otherAttributes',
            type: 'anyAttribute'
        ...
        typeName: 'CREDITCARD_BASE_APPLICANT',
        ...
        propertyInfos: [{
            ...
            typeInfo: '.CREDITCARDBASEAPPLICANT.CURRENTADDRESS'
          }, {
            name: 'previousaddress',
            elementName: 'PREVIOUS_ADDRESS',
            typeInfo: '.CREDITCARDBASEAPPLICANT.PREVIOUSADDRESS'
          }, {
            name: 'mailingaddress',
            elementName: 'MAILING_ADDRESS',
            typeInfo: '.CREDITCARDBASEAPPLICANT.MAILINGADDRESS'
          }, {
            name: 'financialinfo',
            required: true,
            elementName: 'FINANCIAL_INFO',
            typeInfo: '.CREDITCARDBASEAPPLICANT.FINANCIALINFO'
          }, {
            name: 'reference',
            minOccurs: 0,
            maxOccurs: 2,
        ...
        localName: 'CREDITCARDBASEAPPLICANT.PREVIOUSADDRESS',
        typeName: null,
        ...
        localName: 'CREDITCARDLOANINFO.CARDHOLDERS',
        typeName: null,
        propertyInfos: [{
            name: 'cardholder',
            minOccurs: 0,
            ...
            typeInfo: '.CREDITCARDLOANINFO.CARDHOLDERS.CARDHOLDER'
          }]
      }, {
        ...
        localName: 'CREDITCARDBASEAPPLICANT.CURRENTADDRESS',
        typeName: null,
        ...
        localName: 'CREDITCARDBASEAPPLICANT.FINANCIALINFO',
        typeName: null,
        propertyInfos: [{
            ...
            typeInfo: '.CREDITCARDBASEAPPLICANT.FINANCIALINFO.CURRENTEMPLOYMENT'
          }, {
            name: 'previousemployment',
            minOccurs: 0,
            collection: true,
            elementName: 'PREVIOUS_EMPLOYMENT',
            typeInfo: '.CREDITCARDBASEAPPLICANT.FINANCIALINFO.PREVIOUSEMPLOYMENT'
          }, {
            name: 'monthlyincome',
            required: true,
        ...
        localName: 'CREDITCARDAPPLICANT.CREDITREPORT',
        typeName: null,
        propertyInfos: [{
            name: 'value',
            type: 'value'
        ...
        localName: 'CREDITCARDFUNDINGINFO',
        typeName: 'CREDITCARD_FUNDING_INFO',
        ...
        localName: 'CREDITCARDBASEAPPLICANT.FINANCIALINFO.CURRENTEMPLOYMENT',
        typeName: null,
        baseTypeInfo: '.BASEEMPLOYMENT',
        propertyInfos: [{
        ...
        localName: 'CREDITCARDINSURANCE',
        typeName: 'CREDITCARD_INSURANCE',
        ...
        localName: 'CREDITCARDLOAN.COMMENTS',
        typeName: null,
        ...
        localName: 'CREDITCARDSTATUS',
        typeName: 'CREDITCARD_STATUS',
        ...
        localName: 'CREDITCARDLOAN.INTEGRATIONDATALIST',
        typeName: null,
        propertyInfos: [{
        ...
        localName: 'CREDITCARDBASEAPPLICANT.MAILINGADDRESS',
        typeName: null,
        baseTypeInfo: '.BASEADDRESSLOOSE',
        propertyInfos: [{
            name: 'isCurrent',
        ...
        localName: 'CREDITCARDLOAN.FUNDING',
        typeName: null,
        baseTypeInfo: '.CREDITCARDFUNDINGINFO',
        propertyInfos: [{
            name: 'insuranceoptions',
            required: true,
            elementName: 'INSURANCE_OPTIONS',
            typeInfo: '.CREDITCARDLOAN.FUNDING.INSURANCEOPTIONS'
          }]
      }, {
        ...
        localName: 'CREDITCARDLOAN.LOANINFO',
        typeName: null,
        baseTypeInfo: '.CREDITCARDLOANINFO'
      }, {
        ...
        localName: 'CREDITCARDLOAN.FUNDING.INSURANCEOPTIONS',
        typeName: null,
        propertyInfos: [{
        ...
        localName: 'CREDITCARDLOAN.APPLICANTS',
        typeName: null,
        propertyInfos: [{
            name: 'applicant',
            required: true,
        ...
        localName: 'CREDITCARDSYSTEM',
        typeName: 'CREDITCARD_SYSTEM',
        ...
        localName: 'CREDITCARDAPPLICANT',
        typeName: 'CREDITCARD_APPLICANT',
        baseTypeInfo: '.CREDITCARDBASEAPPLICANT',
        propertyInfos: [{
            name: 'otherAttributes',
            type: 'anyAttribute'
          }, {
            name: 'spouse',
            elementName: 'SPOUSE',
            typeInfo: '.CREDITCARDBASEAPPLICANT'
          }, {
            name: 'creditreport',
            elementName: 'CREDIT_REPORT',
            typeInfo: '.CREDITCARDAPPLICANT.CREDITREPORT'
          }, {
    ...
    elementInfos: [{
        elementName: 'CREDITCARD_LOAN',
        typeInfo: '.CREDITCARDLOAN'
      }]
  };
  return {
    creditcard_loan: creditcard_loan
  };
};
if (typeof define === 'function' && define.amd) {
  define([], creditcard_loan_Module_Factory);
}
else {
  var creditcard_loan_Module = creditcard_loan_Module_Factory();
  if (typeof module !== 'undefined' && module.exports) {
    module.exports.creditcard_loan = creditcard_loan_Module.creditcard_loan;
  }
  else {
    var creditcard_loan = creditcard_loan_Module.creditcard_loan;
  }
}